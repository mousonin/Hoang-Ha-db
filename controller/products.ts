...
export const addProduct = async (req: any, res: any) => {
  try {
    ...
    const addProduct = await pool.query(
      `INSERT INTO public."products"("name", "brand", "year of manufacture", "price")
...
export const sortProducts = async (req: any, res: any) => {
  try {
...
export const getDetailProduct = async (req: any, res: any) => {
  try {
    const getDetailProduct = await pool.query(
      `select products.*, brand.description
      from products 
      left join brand
